...
前面介绍的 HashMap有一个重要局限，键值对之间没有特定的顺序，我们还提到，Map接口有另一个重要的实现类`TreeMap`，在`TreeMap`中，键值对之间按键有序，`TreeMap`的实现基础是排序二叉树，本节我们来详细讨论TreeMap。
...
T排在最前面，是因为大写字母都小于小写字母。如果希望忽略大小写呢？可以传递一个比较器，String类有一个静态成员CASE\_INSENSITIVE\_ORDER，它就是一个忽略大小写的Comparator对象，替换第一行代码为：
...
* 不同的是，迭代时，TreeMap按键有序，为了实现有序，它要求：要么键实现Comparable接口，要么创建TreeMap时传递一个Comparator对象。\
  不过，由于TreeMap按键有序，它还支持更多接口和方法，具体来说，它还实现了SortedMap和NavigableMap接口，而NavigableMap接口扩展了SortedMap。
...
![1656000707714-92fe37df-d357-4eec-85c5-7a0eace024f8.png](./img/yoVfK8xLxlad_j71/1656000707714-92fe37df-d357-4eec-85c5-7a0eace024f8-179155.png)
...
* <https://www.cnblogs.com/swiftma/p/5975943.html>


> 更新: 2022-06-24 00:12:44  
> 原文: <https://www.yuque.com/thinkspace/ulag78/laroy4>